...
.. glossary::
  ...
  TTL 
    ...
    from [RFC2181], Section 8) Note that [RFC1035] erroneously stated that
    this is a signed integer; that was fixed by [RFC2181].
    ...
    (Quoted from [RFC1035], Section 3.2.1) Section 4.1.3 of [RFC1035] states
    ...
    this is against the advice in [RFC1035].  An RRset can be flushed from
