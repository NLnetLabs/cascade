...
use cascade_zonedata::{AuthData, DiffData};
...
pub struct Instances {
    ...
    ///
    /// This data structure stores the authoritative instance, and an upcoming
    /// instance (if any). It is available even if an instance does not exist.
    /// It can be cloned for long-term use.
    pub data: Arc<AuthData>,
