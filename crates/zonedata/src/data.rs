...
//! for loaded content and two slots for signed content. Each slot can be used
...
#[derive(Default)]
pub struct Data {
    /// The loaded components of the zone.
    pub loaded: [UnsafeCell<InstanceData>; 2],
...
impl Data {
    ...
    pub const fn new() -> Self {
        Self {
            loaded: [const { UnsafeCell::new(InstanceData::new()) }; 2],
...
/// Data for a loaded or signed instance of a zone.
//
// TODO: This will separate into a loaded and a signed variant.
